...
const AddListing = () => {
  ...
  const { addListingBusiness } = useApi();
  ...
  const handleChange = (e) => {
    ...
    setListing((prevListing) => ({
      ...prevListing,
      [name]: name === 'lowestPrice' || name === 'highestPrice' ? parseFloat(value) : value,
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addListingBusiness(formData); // Use addListingBusiness instead of AddListing
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <Breadcrumbs title="Business Listings" breadcrumbItem="Add Listing Category" />
  ...
  <Input
    ...
    style={inputStyle}
  />
  <FormText color="muted">Enter features separated by commas.</FormText>
</FormGroup>
            ...
            <FormGroup style={formGroupStyle}>
              ...
              <Input
                ...
                name="iframe"
                id="iframe"
                value={listing.iframe}
                onChange={handleChange}
                style={inputStyle}
              />
              <FormText color="muted">Enter iframe code for Google Maps.</FormText>
            </FormGroup>
            <FormGroup style={formGroupStyle}>
