...
const Login = props => {
  ...
  const { userLogin , loginError} = useApi();
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      userLogin(values.email, values.password); // Call userLogin function with email and password
    }
  });
            ...
            <Card>
              <CardBody className="p-4">
                <div>
                  ...
                  >
                    {loginError ? <Alert color="danger"><div>{loginError}</div></Alert> : null}
                    <Row>
                      <Col md={12}>
                        <div className="mb-4">
